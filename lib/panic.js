 ...
 * caDbg to the file "cacore.<pid>", and then exit the program.  This function
...
/*
 * Saves caDbg state to the named file.
 */
 ...
 *				to the event loop.
 *
 *	[global] caDbg		Manages state to be dumped when caPanic is
 *				invoked.
 *
